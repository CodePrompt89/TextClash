...
color 0f
title TextClash {Development Beta}
...
echo.
echo.
echo Current Version: v1.2_indev
echo.
set /p login=
...
echo บ 1) Singleplayer             บ
echo.บ                             บ
echo บ 2) Play Classic Edition     บ
echo.บ                             บ
echo บ 3) Weapon Store             บ
echo.บ                             บ
echo บ 4) Armor Store              บ
echo.บ                             บ
echo บ 5) Legend's Store           บ
echo.บ                             บ
echo บ 6) Trading Post             บ
echo.บ                             บ
echo บ 7) Smuggler                 บ
echo.บ                             บ
...
echo.บ                             บ
echo บ 10) TextClash Bank          บ
echo.บ                             บ
echo บ 11) Quest Hall              บ
echo.บ                             บ
echo บ 12) Your Inventory          บ
...
if %x1% EQU 3 goto weaponstore
if %x1% EQU 4 goto Armorstore
if %x1% EQU 5 goto legendsstore
if %x1% EQU 6 goto gstore
...
if %x1% EQU 12 goto checkitems
if %x1% EQU 13 goto settings
if %x1% EQU 14 goto entergame
goto MENU
...
:BANK
title TextClash Bank
set destination1=BANK
cls
echo.
echo Welcome to the TextClash Bank^^! Here are your accounts which you can store up to 1,000,000,000 (1B) gold into each.
echo.
...
title TextClash - Weapon Shop
mode con cols=160 lines=62
cls
echo TextClash Weapon Shop
echo.
...
title TextClash - Armor Shop
mode con cols=160 lines=62
cls
echo TextClash - Armor Shop
echo.
echo You currently have %money% Gold.
echo.
echo.
...
title TextClash - Legend's Store
mode con cols=160 lines=62
cls
echo TextClash Legend's Store
echo.
...
echo.
echo.
echo Multiplayer Is Currently Offline.....
echo STOP CODE: 952110
echo.
pause>nul
goto SAVE_GAME_FILES

@echo off
title TextClash (Legacy Version)
color 0f

:Menu
cls
echo.
echo Welcome To The Legacy Version Of TextClash!!
echo.
echo Made By: Matrix98#2662
echo.
echo S) Start
echo E) Exit Classic Edition
echo.
set /p m=" "
if /i %m% == s goto start
if /i %m% == e MENU
...
echo Y) Yes
echo N) No
echo I) List Account Info
set /p yn=" "
if /i %yn% == y goto login
if /i %yn% == n goto createAcount
if /i %yn% == i goto listAcountInfo
set yn=
goto login-createAcount
...
echo _____________________________________
echo.
echo L) Legacy Singleplayer
echo M) MultiPlayer (Beta!)
echo S) Save Game
echo E) Exit Classic Edition
set /p m=" "
if /i %m% == l goto SinglePlayerMenu
...
:waitForJoin
cls
echo Waiting... (Cancel by closing the game)
...
:waitForPermision
cls
echo Waiting for permision... (Don't close the game until your allowed in or not!)
ping localhost -n 1 >nul
for /f " eol=X tokens=1,2,3,* " %%l in (%gname%.txt) do set %%l
...
set /p m=" "
if /i %m% == e goto Home
if %m% == p1 goto MapPack#1
if %m% == p2 goto MapPack#2
if %m% == p3 goto MapPack#3
set m=
...
:color
title TextClash - Settings - Color Change
cls
echo.
...
:namechange
title TextClash - Username Change
cls
echo.
